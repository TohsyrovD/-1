...
def generate_access_config(intf_vlan_mapping, access_template,psecurity=None):
    ...
    for inter, vlan in intf_vlan_mapping.items():
        ...
        ac.append('interface {}'.format(inter))
...
ret = generate_access_config(access_config, access_mode_template,port_security_template)
ret2 = generate_access_config(access_config, access_mode_template)
print(ret)
